...
const char* Sim800Lid = "lol";
const char* paSim800Lword = "llllllllii";
...
String header;
String imageParam = "";
String numberParam = "+9779819642608";
...
void setup() {
  Serial.begin(9600);
  Serial.println("Team Agni Netra");
      ...
      if (client.available()) {             // if there's bytes to read from the client,
        ...
        if (c == '\n') {                    // if the byte is a newline character
          ...
          if (currentLine.length() == 0) {
            ...
            client.println("TEAM Agni Netra");
...
void sendSMS(String image,String number) {
    ...
    Serial.println("Sending MessLage, Agni Netra");
    Sim800L.println("AT+CMGF=1\r");
    delay(1000);
    Sim800L.println("AT+CNMI=2,2,0,0,0\r");
    delay(1000);
    // Sim800L.print("AT+CMGS=\"+9779819642608\"\r");
